...
@Table(name = "functionimplementation")
public class FunctionImplementation extends AdditionalServiceType implements Serializable, Entity<Long> {

    private static final long serialVersionUID = -352360437938844596L;
